...
import assignemt4.models.EdgeDataImpl;
...
public class DirectedWeightedGraphImpl implements DirectedWeightedGraph {
    ...
    public static DirectedWeightedGraph load(String json) {
        DirectedWeightedGraphJson dgj = new Gson().fromJson(json, DirectedWeightedGraphJson.class);
